...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        ...
        (() => {
            ...
            // CORRECTED: This is the valid URL to your CSS file
            const CSS_URL = 'https://cdn.jsdelivr.net/gh/aritra404/miso_chatbot/chatbot.css';
            ...
            `;
            // Use a safer method to add the HTML to the page
            document.body.insertAdjacentHTML('beforeend', chatbotHTML);
            
            // --- 3. Select elements and add event listeners ---
