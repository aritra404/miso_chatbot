...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        ...
        (() => {
            ...
            const CSS_URL = 'https://cdn.jsdelivr.net/gh/aritra404/miso_chatbot/chatbot-v6.css';
            ...
            const chatbotHTML = `
                <div class="chatbot-container">
                    <div class="chat-popup" id="chatPopup">Hey! what are you searching for? 👀</div>
            ...
            const popupMessages = [
                ...
                "looking for jewelry that slaps? 💎",
                "sonia here! what's the vibe today? 🔥",
                "let's find you something amazing! 💫",
                "psst... i've got the perfect pieces! 😉",
                "ready to upgrade your jewelry game? 💯"
            ];
            ...
            const showPopup = () => {
                ...
                chatPopup.textContent = randomMessage;
                
                // Show with animation
                chatPopup.classList.add('show', 'bounce');
            ...
            // Hide popup when hovering over toggle
            chatToggle.addEventListener('mouseenter', hidePopup);

            // Hide popup when clicking on it
            ...
            // Optional: Stop popups when user interacts with the page extensively
            let userActivityCount = 0;
            document.addEventListener('click', () => {
                userActivityCount++;
                // After 10 clicks, reduce popup frequency
